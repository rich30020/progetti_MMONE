...
// Ottieni tutte le arnie (hives)
$hives = $controller->fetchAllHives();

// Funzione per generare le opzioni degli hive
function generateHiveOptions($hives)
{
    $options = '';
    foreach ($hives as $hive) {
        $options .= "<div class='form-check mb-3'>
    ...
    <div class="container">
        <div class="custom-container">
            <form id="myForm" action="select-game.php" method="POST">
                ...
                <?php
                    // Chiamata della funzione per generare le opzioni
                    echo generateHiveOptions($hives);
                ?>
                <button value="create-game" type="submit" name="btn_submit" class="btn btn-custom">Create Game</button>
            </form>
        </div>
    </div>
