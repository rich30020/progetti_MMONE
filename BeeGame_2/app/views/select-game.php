            ...
            <ul class="list-group">
                ...
                foreach ($games as $game) {
                    echo '<li class="list-group-item">
                            ...
                            <span class="hive-difficulty">' . $game->getHive()->getDifficulty() . ' > Round ' . $game->getRound() . ' &nbsp;&nbsp; Vite ' . $game->getLives() . '</span>
                            <form action="phaser-game.php" method="POST">
                                <button type="submit" name="game_id" value="' . $game->getId() . '" class="btn btn-action btn-sm btn-custom">
                                    <svg fill="#000000" height="200px" width="200px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330 330" xml:space="preserve">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier">
                                            <path id="XMLID_222_" d="M250.606,154.389l-150-149.996c-5.857-5.858-15.355-5.858-21.213,0.001c-5.857,5.858-5.857,15.355,0.001,21.213l139.393,139.39L79.393,304.394c-5.857,5.858-5.857,15.355,0.001,21.213C82.322,328.536,86.161,330,90,330s7.678-1.464,10.607-4.394l149.999-150.004c2.814-2.813,4.394-6.628,4.394-10.606C255,161.018,253.42,157.202,250.606,154.389z"></path>
                                        </g>
                                    </svg>
                                </button>
                            </form>
